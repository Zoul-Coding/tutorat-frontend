...
const AllProduct: React.FC<AllProductProps> = ({ dataSearch }) => {
  ...
  const products =
    Array.isArray(dataSearch?.product) && dataSearch?.product.length > 0
      ? dataSearch?.product || dataSearch.categorie
      : dataPayload?.data;
  ...
  return (
    <section className="mb-8">
      <div className="px-5">
        {dataSearch &&
        Array.isArray(dataSearch.product) &&
